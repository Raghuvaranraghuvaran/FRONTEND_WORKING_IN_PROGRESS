...
urlpatterns = [
    ...
    path("delivery-agents/risk-overview/", views.DeliveryAgentsView.as_view(), name="admin-delivery-agents-overview"),
    path("delivery-agents/<int:pk>/investigate/", views.DeliveryAgentInvestigateView.as_view(), name="admin-delivery-agent-investigate"),
    path("delivery-agents/<int:pk>/sign-off/", views.DeliveryAgentSignOffView.as_view(), name="admin-delivery-agent-sign-off"),
    path("delivery-agents/<int:pk>/details/", views.DeliveryAgentDetailsView.as_view(), name="admin-delivery-agent-details"),
