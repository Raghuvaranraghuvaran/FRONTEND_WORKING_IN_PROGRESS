            ...
            {shopper ? (
              <div className="relative" ref={profileRef}>
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl px-3 py-2 text-xs font-semibold text-white shadow-md hover:opacity-90 transition cursor-pointer"
                >
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white/25 text-xs font-bold uppercase text-white">
                    {(shopper.email || shopper.name || 'U').charAt(0).toUpperCase()}
                  </div>
                  <span className="hidden sm:inline-block max-w-[130px] truncate text-white font-medium">
