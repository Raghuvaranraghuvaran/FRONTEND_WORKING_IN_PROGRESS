    ...
    <div>
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">Create or update your store tenant and merchant ID.</p>
        </div>
      ...
      {saved ? (
        <div className="rounded-2xl border border-slate-200 bg-white p-8 text-center">
          ...
          <div className="mt-6 rounded-lg bg-slate-50 p-4 text-left">
            <p className="text-xs font-medium uppercase tracking-wide text-slate-500">Merchant ID</p>
            <code className="mt-1 block break-all text-sm font-semibold text-slate-900">{saved.id}</code>
          </div>
        ...
        <form onSubmit={submit} className="mx-auto max-w-2xl rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <p className="mt-1 text-sm text-slate-500">
            This creates the store profile and assigns a unique merchant ID.
          </p>
