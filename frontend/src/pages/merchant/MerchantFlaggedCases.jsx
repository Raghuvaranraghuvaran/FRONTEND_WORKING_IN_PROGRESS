          ...
          {selectedIds.size > 0 && (
            <div className="flex flex-wrap items-center gap-2 pt-2 lg:pt-0">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-slate-100 text-slate-600 text-xs font-bold hover:bg-slate-200 cursor-pointer transition-colors"
              >
                Clear
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 pt-1">
          <div className="lg:col-span-3">
            <select
              ...
              className="w-full rounded-xl border border-slate-300 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-1 focus:ring-indigo-500"
            >
          ...
          <div className="sm:col-span-2 lg:col-span-6 relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-300 bg-white pl-9 pr-3.5 py-2 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-indigo-500"
            />
          </div>
        </div>
      </div>
          ...
          {sorted.map(record => {
            ...
            return (
              <motion.div
                ...
                className={`relative rounded-2xl border p-4 sm:p-5 transition-all shadow-xs hover:shadow-md bg-white ${
                  isSwap
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <input
                      ...
                      className="h-4 w-4 mt-1 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 shrink-0 cursor-pointer"
                    />
                    {/* Left Info */}
                  ...
                  {/* Right Actions & Value */}
                  <div className="flex items-center justify-between lg:justify-end gap-4 sm:gap-6 pt-3 lg:pt-0 border-t lg:border-t-0 border-slate-100 shrink-0">
                    <div className="text-left lg:text-right">
                      <span className="text-[10px] font-bold uppercase text-slate-400 block">Claimed Value</span>
                    ...
                    <Link
                      ...
                      className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white px-4 sm:px-5 py-2.5 text-xs font-black shadow-md transition-all active:scale-[0.98] no-underline shrink-0"
                    >
