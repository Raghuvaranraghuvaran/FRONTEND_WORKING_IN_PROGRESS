      ...
      <main style={{
        ...
        <div style={{ width: '100%', maxWidth: 460 }}>
          ...
          <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 22, textDecoration: 'none' }}>
            ...
            <div>
              <div style={{ fontSize: 17, fontWeight: 700, color: '#1e1b3a', lineHeight: 1.2 }}>ReturnGuard</div>
              <div style={{ fontSize: 12, color: '#6b7280', marginTop: 1 }}>Smart Returns. Happy Customers.</div>
            </div>
          </Link>
          ...
          <div style={{
            ...
            {activeTab === 'pw' && (
              <form onSubmit={submitPassword}>
                ...
                <div className="rg-field" style={{ ...field, borderColor: focusedField === 'email' ? A : 'rgba(0,0,0,0.12)' }}>
                  <IconMail />
                  <input className="rg-input" type="email" required placeholder="you@example.com"
                ...
                <div className="rg-field" style={{ ...field, borderColor: focusedField === 'pw' ? A : 'rgba(0,0,0,0.12)' }}>
                  <IconLock />
                  <input className="rg-input" type="password" required placeholder="Enter your password"
            ...
            {activeTab === 'otp' && (!otpSent ? (
              <div>
                <label style={lbl}>Email Address</label>
                <div className="rg-field" style={{ ...field, borderColor: 'rgba(0,0,0,0.12)' }}>
                  <IconMail />
                  <input className="rg-input" type="email" required placeholder="you@example.com"
              ...
              <form onSubmit={verifyOTP}>
                ...
                <div className="rg-field" style={{ ...field, borderColor: 'rgba(0,0,0,0.12)' }}>
                  <input className="rg-input" inputMode="numeric" pattern="\d{6}" maxLength={6} required
